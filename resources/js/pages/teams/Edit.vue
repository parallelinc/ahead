<script setup lang="ts">
    ...
    const pageTitle = computed(() =>
        props.permissions.canUpdateTeam ? `Edit ${props.team.name}` : `View ${props.team.name}`,
    );
    ...
    <div class="flex flex-col space-y-10">
        ...
        <div v-if="permissions.canUpdateTeam" class="space-y-6">
            ...
            <Form v-bind="update.form(team.slug)" class="space-y-6" v-slot="{ errors, processing }">
                <div class="grid gap-2">
                    ...
                    <Input id="name" name="name" data-test="team-name-input" :default-value="team.name" required />
                    <InputError :message="errors.name" />
                </div>

                <div class="flex items-center gap-4">
                    <Button type="submit" data-test="team-save-button" :disabled="processing">Save</Button>
                </div>
            </Form>
        </div>
        ...
        <div v-if="permissions.canDeleteTeam && !team.isPersonal" class="space-y-6">
            ...
            <div
                ...
                <Button data-test="delete-team-button" variant="destructive" @click="deleteDialogOpen = true">
                    Delete team
                </Button>
            </div>
        </div>
